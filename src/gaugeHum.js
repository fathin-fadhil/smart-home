...
(function(global, factory) {
  var GaugeHum = factory(global);
  if(typeof define === "function" && define.amd) {
    // AMD support
    define(function() {return GaugeHum;});
  }else if(typeof module === "object" && module.exports) {
    // CommonJS support
    module.exports = GaugeHum;
  }else {
    // We are probably running in the browser
    global.GaugeHum = GaugeHum;
  }
  ...
  var GaugeHum = (function() {
    var SVG_NS = "http://www.w3.org/2000/svg";

    var GaugeHumDefaults = {
      centerX: 50,
      centerY: 50
    };
    ...
    function getDialCoords(radius, startAngle, endAngle) {
      var cx = GaugeHumDefaults.centerX,
          cy = GaugeHumDefaults.centerY;
      return {
    ...
    /**
     * Creates a GaugeHum object. This should be called without the 'new' operator. Various options
     ...
     * @return a GaugeHum object
     */
    return function GaugeHum(elem, opts) {
      ...
      function initializeGaugeHum(elem) {
      ...
      function updateGaugeHum(theValue, frame) {
      ...
      function setGaugeHumColor(value, duration) {        
      ...
      instance = {
        setMaxValue: function(max) {
          limit = max;
          updateGaugeHum(value);
        },
        setValue: function(val) {
          value = normalize(val, min, limit);
          if(gaugeColor) {
            setGaugeHumColor(value, 0)
          }
          updateGaugeHum(value);
        },
        setValueAnimated: function(val, duration) {
          ...
          if(gaugeColor) {
            setGaugeHumColor(value, duration);
          }
          Animation({
            start: oldVal || 0,
            end: value,
      ...
      initializeGaugeHum(gaugeContainer);
